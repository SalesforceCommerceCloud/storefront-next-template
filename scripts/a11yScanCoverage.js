...
const ALLOWLIST = {
    ...
    '_app.order-lookup.verify.$orderNo': 'deferred:auto-discovery,multi-step OTP-gated flow, no Scenario yet',
    '_app.order-lookup.results.$orderNo': 'deferred:auto-discovery,multi-step OTP-gated flow, no Scenario yet',
