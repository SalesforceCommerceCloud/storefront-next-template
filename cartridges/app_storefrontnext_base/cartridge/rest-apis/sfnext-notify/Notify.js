...
/**
 * SCAPI Custom API handler for SFNext Notify.
 *
 * Authentication and scope enforcement (ShopperToken + c_sfnext_notify) are
...
exports.notify = function () {
    if (!isNotifyEnabled()) {
        RESTResponseMgr.createError(
            ...
            'Service Unavailable',
            'Notifications are disabled on this instance (sfnextNotifyEnabled = false)'
        ).render();
        return;
    }
