...
declare const siteContext: react_router14.RouterContext<SiteContext | null>;
/**
...
declare function getSiteContextCookies(context: Readonly<RouterContextProvider>): {
  siteCookie: react_router14.Cookie;
  localeCookie: react_router14.Cookie;
  currencyCookie: react_router14.Cookie;
} | null;
/**
