import { i as Url, r as Site$1, t as Locale$1 } from "./types.js";
import { PropsWithChildren } from "react";
import * as react_jsx_runtime3 from "react/jsx-runtime";
import * as react_router20 from "react-router";
...
declare function SiteProvider({
  ...
  currency,
  children
}: PropsWithChildren<SiteContextValue>): react_jsx_runtime3.JSX.Element;
/**
 ...
 */
declare function extractPrefixParamValues({
  pathname,
  prefix
}: {
  pathname: string;
...
declare const siteContext: react_router20.RouterContext<SiteContext | null>;
/**
...
declare function getSiteContextCookies(context: Readonly<RouterContextProvider>): {
  siteCookie: react_router20.Cookie;
  localeCookie: react_router20.Cookie;
  currencyCookie: react_router20.Cookie;
} | null;
/**
