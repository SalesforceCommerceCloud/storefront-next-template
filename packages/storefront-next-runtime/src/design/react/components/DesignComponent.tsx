...
export function DesignComponent(props: DesignComponentProps<Record<string, unknown>>): React.JSX.Element {
    ...
    return (
        // oxlint-disable-next-line jsx-a11y/no-static-element-interactions, jsx-a11y/click-events-have-key-events -- Page Designer design-mode drop target (mouse drag-and-drop only); keyboard-accessible move/delete are provided by the toolbox buttons in DesignFrame
        <div
            ref={dragRef}
            className={classes}
