 ...
 * - Base path extraction: Saves ~1054 bytes
 * - Abbreviated keys: Saves ~442 bytes (m=method, b=base, s=suffix)
 * - Total savings: ~1496 bytes
 *
...
export const operations = {
  ...
  completeCustomerPaymentMethodReferenceSetup: { m: 'POST' as const, b: BASE_PATH, s: '/customers/{customerId}/payment-method-references/actions/complete' },
